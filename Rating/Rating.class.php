 ...
 * @version    1.20.0
 * @version    $Id: Rating.class.php 9745 2013-06-14 12:09:29Z pwirth $
...
class Rating extends BsExtensionMW {
	 ...
	 */
	public static function ajaxVote( $sRefType, $sRef, $iValue, $sViewName = '', $sVotable = "", $iUserID = 0, $iArticleID = 0 ) {
		global $wgUser;
